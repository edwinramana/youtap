...
//
//     final tvPopular = tvPopularFromJson(jsonString);

import 'dart:convert';

TVPopular tvPopularFromJson(String str) => TVPopular.fromJson(json.decode(str));

String tvPopularToJson(TVPopular data) => json.encode(data.toJson());
